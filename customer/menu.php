                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                               ...
                               <ul class="list-unstyled">
                                    <li><a href="panel.php?id=<?php echo $id;?>">Mis evetos</a></li>
                                </ul>
                            </li>
                             <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="ti-home"></i> <span>Mis clientes </span> </a>
                                <ul class="list-unstyled">
                                    <li><a href="coordinadores.php">Listado de clientes</a></li>
